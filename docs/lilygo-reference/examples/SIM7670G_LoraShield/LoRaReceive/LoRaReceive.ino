...
#define SIMSHIELD_MOSI                      (42) // SHIELD 23
#define SIMSHIELD_MISO                      (41) // SHIELD 19
#define SIMSHIELD_SCK                       (40) // SHIELD 18
#define SIMSHIELD_RADIO_RST                 (21) // SHIELD 12
#define SIMSHIELD_RADIO_CS                  (39) // SHIELD 5
#define SIMSHIELD_RADIO_BUSY                (6)  // SHIELD 33 Jumpers are required; see README.
#define SIMSHIELD_RADIO_IRQ                 (7)  // SHIELD 34 Jumpers are required; see README.
